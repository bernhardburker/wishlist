/**
 * Standard-Veranstaltungen und Wünsche zur Initialisierung.
 * Jede Veranstaltung besitzt eigene Wünsche, Texte und Reservierungsstände.
 */

export const defaultEvents = [
  {
    id: "geburtstag-2026",
    slug: "geburtstag-2026",
    title: "Emilias 4. Geburtstag 🎂",
    subtitle: "Herzlich willkommen! Hier findet ihr alle Geschenkideen für Emilias 4. Geburtstag. Wählt einfach etwas Schönes aus und reserviert es mit eurem Namen.",
    date: "2026-09-15",
    icon: "🎂",
    isArchived: false,
    wishes: [
  ...
  {
    id: "weihnachten-2026",
    slug: "weihnachten-2026",
    title: "Weihnachten 2026 🎄",
    subtitle: "Unsere festliche Wunschliste für Weihnachten. Stöbert gerne durch und reserviert, was ihr schenken möchtet.",
    date: "2026-12-24",
    icon: "🎄",
    isArchived: false,
    wishes: [
      {
        id: "wish-xmas-1",
        title: "Holz-Schlitten mit Lehne",
        url: "https://www.otto.de/p/hoernerschlitten-holz-mit-rueckenlehne-S0123",
        price: 59.90,
        category: "Garten & Outdoor",
        priority: "high",
        image: "https://images.unsplash.com/photo-1517824806704-9040b037703b?w=600&auto=format&fit=crop&q=80",
        description: "Klassischer Hörnerschlitten für den ersten Schnee.",
        shopName: "OTTO",
        status: "available",
        reservedBy: "",
        reservedAt: null,
        note: "Inklusive Zugseil",
        reservePin: ""
      },
      {
        id: "wish-xmas-2",
        ...
        description: "Für die kalte Jahreszeit.",
        shopName: "OTTO",
        status: "available",
        reservedBy: "",
        reservedAt: null,
        note: "Größe 116 in Dunkelblau",
        reservePin: ""
      }
    ]
  }
